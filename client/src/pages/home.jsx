          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-12 animate-fadeIn p-8">
              ...
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
                Take our FREE 3-minute skin test. Get doctor-approved
                personalized treatment plans that target the root causes of your
                skin concerns.
              </p>
            ...
            <div className="relative animate-float p-1">
              ...
              <div
                className="absolute -top-3 -right-1 bg-white rounded-2xl shadow-2xl p-4 animate-slideRight"
        ...
        <div className="container-custom relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              See how our personalized treatment approach helped thousands
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-700 mb-3 italic">
                  "I struggled with acne for years. This personalized approach
                  finally worked! My skin is clearer and I feel confident
                  again."
                </p>
                <p className="font-semibold text-slate-900">Priya S., Mumbai</p>
                <p className="text-sm text-slate-600">
                  Acne Treatment • 60 Days
                </p>
              </div>
            </Card>
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-700 mb-3 italic">
                  "I struggled with pimple problems for years. This personalized
                  approach finally worked! My skin is clearer and I feel
                  confident again."
                </p>
                <p className="font-semibold text-slate-900">Laara, UK</p>
                <p className="text-sm text-slate-600">
                  Pimple Treatment • 60 Days
                </p>
              </div>
            </Card>
          </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 p-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-lg text-slate-700 mb-4">
                    We're so confident in our treatment approach that if you
                    don't see visible results, we'll refund your entire
        ...
        <div className="py-20 relative">
          ...
          <div className="container-custom text-center relative z-10">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join 50,000+ people who trusted us with their skin health. Take
            ...
            <p className="text-sm text-white/80 mt-4">
              ⏱️ Takes only 3 minutes • 🔒 100% Confidential • ✅ No credit card
              required
            </p>
          </div>
        </div>
