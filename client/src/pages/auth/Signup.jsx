        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white w-full max-w-xl mx-auto">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Your journey to healthier skin</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              {[
                { icon: CheckCircle, text: 'Personalized AI-powered skin analysis' },
                { icon: Shield, text: 'Doctor-approved treatment plans' },
                { icon: Sparkles, text: 'Track your progress with smart insights' },
              ].map((item, index) => {
                const Icon = item.icon;
                return (
                  <div key={index} className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/15 transition-all">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                      <Icon className="h-5 w-5 text-white" />
                    </div>
                    <p className="text-base text-white/90 font-medium">{item.text}</p>
                  </div>
                );
              })}
            </div>
            ...
            <div className="mt-8 p-5 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
              ...
              <p className="text-white/90 italic mb-3 text-sm leading-relaxed">
                "This platform transformed my skincare routine. The personalized approach really works!"
              </p>
              <p className="text-xs text-white/70 font-medium">— Priya S., Mumbai</p>
            </div>
    ...
    <div className="w-full max-w-md">
      ...
      <div className="mb-8">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2">
          ...
          <span className="text-xs font-semibold text-emerald-700">Join 10,000+ Users</span>
        </div>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="overflow-hidden rounded-xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-4 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="mb-1 text-sm font-bold text-slate-900">Your Privacy Matters</p>
              <p className="text-xs leading-relaxed text-slate-600">
                256-bit encryption protects your data. We never sell or share your personal information.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            >
              ...
              <span className="text-xs font-semibold text-slate-700">{benefit.text}</span>
            </div>
          ))}
        </div>
      </div>
