...
<<<<<<< Updated upstream
  ...
  const renderAboutStep = () => (
    <div className="sm:mx-auto -mx-15 max-w-4xl  space-y-8 sm:space-y-12 px-2 sm:px-4 py-4 sm:py-8">
      ...
      <div className="space-y-3 sm:space-y-4 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm sm:text-base text-slate-600">
          Your information helps us create personalized skincare recommendations
          tailored just for you. All data is encrypted and stored securely.
        </p>
      </div>
          ...
          <label className="group space-y-2.5 text-left">
            ...
            <div className="relative">
              <input
                ...
                value={lead.age}
                onChange={(event) =>
                  handleLeadChange("age", event.target.value)
                }
                placeholder="24"
                className="w-full rounded-lg border-2 border-slate-200 bg-white px-4 py-3.5 text-base text-slate-900 shadow-sm transition-all duration-200 placeholder:text-slate-400 hover:border-slate-300 focus:border-[#97b94f] focus:outline-none focus:ring-4 focus:ring-[#97b94f]/10"
                required
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 sm:grid-cols-4">
              {[
                ...
                <button
                  ...
                  className={`group relative overflow-hidden rounded-xl border-2 px-2 sm:px-4 py-3 sm:py-4 text-xs sm:text-sm font-semibold shadow-sm transition-all duration-200 ${
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-600">
              ...
              <a
                href="#"
                className="ml-1 font-medium text-[#97b94f] hover:underline"
              >
                Learn more
              </a>
            </p>
 ...
 const renderSkinStep = () => (
    <div className="mx-auto max-w-5xl space-y-10 sm:space-y-12 px-4 sm:px-6 py-6 sm:py-8">
        {/* Header Section */}
        <div className="space-y-3 sm:space-y-4 text-center px-1 sm:px-0 -mx-15">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900">
        ...
        {/* Primary Concern Section - Mobile Optimized */}
        <div className="space-y-6 -mx-15">
            <div className="flex items-start gap-3 px-1">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#97b94f] text-sm font-bold text-white">
                    1
                </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {CONCERN_OPTIONS.map((option) => (
                    <button
                        ...
                        className={`group relative overflow-hidden rounded-3xl border-2 px-5 py-5 text-left sm:text-center text-sm font-semibold shadow-sm transition-all duration-200 min-h-[72px] flex items-center ${
                    ...
                    >
                        <span className="relative z-10 flex w-full items-center gap-3 sm:justify-center">
                            {option.label}
                            {answers.main_concern === option.value && (
                                <svg
                                    className="h-5 w-5 text-[#97b94f] flex-shrink-0 ml-auto sm:ml-0"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                >
                                    <path
        ...
        {/* Sensitivity Section - Different Layout on Mobile */}
        <div className="space-y-6 -mx-15">
            <div className="flex items-start gap-3 px-1">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#97b94f] text-sm font-bold text-white">
                    2
                ...
                <div className="pt-0.5">
                    ...
                    <p className="text-sm text-slate-500 mt-1">How reactive is your skin?</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                {SENSITIVITY_OPTIONS.map((option) => (
                    <button
                        ...
                        className={`group relative overflow-hidden rounded-3xl border-2 px-5 py-6 text-center text-sm font-semibold shadow-sm transition-all duration-200 min-h-[92px] flex flex-col items-center justify-center gap-4 ${
                            answers.sensitivity === option.value
                                ? "border-[#97b94f] bg-gradient-to-br from-[#f0f5e3] to-[#e8f0d5] text-slate-900 shadow-md ring-2 ring-[#97b94f]/20"
                                : "border-slate-200 bg-white text-slate-700 hover:border-[#b7cc79] hover:bg-slate-50 hover:shadow-md"
                        }`}
                    >
                        {/* Sensitivity dots - larger and clearer on mobile */}
                        <div className="flex gap-2">
                            {[
                                ...Array(
                                    option.value === "none" ? 1 :
                                    option.value === "mild" ? 2 :
                                    option.value === "moderate" ? 3 : 4
                                ),
                            ].map((_, i) => (
                                <div
                                    key={i}
                        ...
                        <span className="relative z-10 font-medium text-base">{option.label}</span>

                        {/* Checkmark - positioned nicely */}
                        {answers.sensitivity === option.value && (
                            <svg
                                className="absolute bottom-4 right-4 h-6 w-6 text-[#97b94f]"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                            >
                                <path
        ...
        {/* Tip Section */}
        <div className="rounded-3xl -mx-15 border border-slate-200 bg-gradient-to-br from-blue-50 to-white p-5 shadow-sm">
        ...
        <div className="mx-auto w-full max-w-3xl">
            ...
            <div className="mb-8 space-y-3 text-center sm:mb-10">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-500 sm:text-base">
                    Personalized skincare starts here. All your data is encrypted and stored securely.
                </p>
            </div>
                ...
                <div className="relative space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <label className="group space-y-1.5">
                            ...
                            <div className="relative">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                                    <svg className="h-4 w-4 text-slate-300 transition-colors group-focus-within:text-[#97b94f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                            {[
                                { value: 'female',     label: 'Female',            icon: '♀', color: 'from-rose-50 to-pink-50',   border: 'border-rose-200',   ring: 'ring-rose-200/50',   text: 'text-rose-600'   },
                                { value: 'male',       label: 'Male',              icon: '♂', color: 'from-sky-50 to-blue-50',    border: 'border-sky-200',    ring: 'ring-sky-200/50',    text: 'text-sky-600'    },
                                { value: 'non-binary', label: 'Non-binary',        icon: '⚥', color: 'from-violet-50 to-purple-50', border: 'border-violet-200', ring: 'ring-violet-200/50', text: 'text-violet-600' },
                                { value: 'prefer-not', label: 'Prefer not to say', icon: '·', color: 'from-slate-50 to-gray-50',  border: 'border-slate-300',  ring: 'ring-slate-200/50',  text: 'text-slate-500'  },
                            ].map((option) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className="leading-snug text-center">{option.label}</span>
                                        {isSelected && (
                                            <span className="absolute right-2 top-2">
                                                <svg className="h-3.5 w-3.5 text-[#97b94f]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="mt-4 flex items-start gap-3 rounded-2xl border border-[#d4e9a8] bg-gradient-to-r from-[#f2f9e4] to-[#edf7d6] px-4 py-3.5 shadow-sm">
                ...
                <p className="text-xs leading-relaxed text-slate-500">
                    ...
                    Industry-standard encryption. We never share your data without explicit consent.{' '}
                    <a href="#" className="font-medium text-[#6a8a2e] hover:underline">Learn more</a>
                </p>
            </div>
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f4f9ec] via-[#eef5e0] to-[#e6f0d4] px-4 py-8 sm:py-12">
        <div className="mx-auto w-full max-w-3xl">
            ...
            <div className="mb-8 space-y-3 text-center sm:mb-10">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-500 sm:text-base">
                    Understanding your skin profile helps us recommend treatments perfectly suited to your needs.
                </p>
            </div>
                ...
                <div className="relative space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-bold text-slate-800">Optional Skin Goals</p>
                                <p className="text-xs text-slate-400">What would you like to improve?</p>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-bold text-slate-800">Sensitivity Level</p>
                                <p className="text-xs text-slate-400">How reactive is your skin to products or environment?</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                            {SENSITIVITY_OPTIONS.map((option) => {
                                ...
                                const dotColor =
                                    option.value === 'none'     ? 'bg-emerald-400' :
                                    option.value === 'mild'     ? 'bg-yellow-400'  :
                                    option.value === 'moderate' ? 'bg-orange-400'  :
                                                                  'bg-red-400';

                                const selectedStyle =
                                    option.value === 'none'     ? 'border-emerald-300 bg-gradient-to-br from-emerald-50 to-green-50 text-emerald-700 ring-emerald-200/60'   :
                                    option.value === 'mild'     ? 'border-yellow-300 bg-gradient-to-br from-yellow-50 to-amber-50 text-yellow-700 ring-yellow-200/60'       :
                                    option.value === 'moderate' ? 'border-orange-300 bg-gradient-to-br from-orange-50 to-amber-50 text-orange-700 ring-orange-200/60'       :
                                ...
                                return (
                                    ...
                                    >
                                            ...
                                            {[...Array(4)].map((_, i) => (
                                                <div
                                                    ...
                                                    className={`h-2 w-2 rounded-full transition-all duration-200 ${
                                                        i < dotCount
                                                            ? isSelected ? dotColor : 'bg-slate-300 group-hover:bg-slate-400'
                                                            : 'bg-slate-200'
                                                    }`}
                                                />
                                            ))}
                                        ...
                                        {isSelected && (
                                            <span className="absolute right-2 top-2">
                                                <svg className="h-3.5 w-3.5 text-current opacity-70" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                                </svg>
                                            </span>
                                        )}
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 rounded-xl border border-slate-100 bg-slate-50/60 px-4 py-2.5">
                            {[
                                ...
                                <span key={item.label} className="flex items-center gap-1.5 text-[10px] font-semibold text-slate-400">
            ...
            <div className="mt-4 flex items-start gap-3 rounded-2xl border border-sky-100 bg-gradient-to-r from-sky-50 to-blue-50/60 px-4 py-3.5 shadow-sm">
                ...
                <p className="text-xs leading-relaxed text-slate-500">
                    ...
                    Choose what feels most accurate — our specialists can refine this during your consultation.
                </p>
            </div>
        ...
        <div className="min-h-screen w-full bg-gradient-to-br from-[#f4f9ec] via-[#eef5e0] to-[#e6f0d4] px-4 py-8 sm:py-12">
            <div className="mx-auto w-full max-w-3xl">
                ...
                <div className="mb-8 space-y-3 text-center sm:mb-10">
                    ...
                    <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-500 sm:text-base">
                        Daily habits play a crucial role in skin health. Help us understand your routine for holistic recommendations.
                    </p>
                </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-1 items-center gap-2">
                                            <span
                                                ...
                                                style={{ background: field.badgeBg, border: `1.5px solid ${field.badgeBorder}` }}
                                            >
                                                {field.icon}
                                            </span>
                                            <div>
                                                <p className="text-sm font-bold text-slate-800">{field.title}</p>
                                                <p className="text-xs text-slate-400">{field.subtitle}</p>
                                            </div>
                                        </div>
                                                ...
                                                >
                                                    <div className="flex items-start justify-between gap-2">
                                                        <div>
                                                            ...
                                                            {option.description && (
                                                                <p className={`mt-1 text-[10px] font-normal leading-relaxed ${
                ...
                <div className="mt-4 overflow-hidden rounded-2xl border border-[#d4e9a8] bg-gradient-to-r from-[#f2f9e4] to-[#edf7d6] shadow-sm">
                    <div className="flex items-start gap-3 px-4 py-4">
                        ...
                        <div className="flex-1">
                            <p className="text-xs font-bold text-slate-700">Holistic Skincare Approach</p>
                    ...
                    <div className="grid grid-cols-2 divide-x divide-[#d4e9a8] border-t border-[#d4e9a8] sm:grid-cols-4">
                        {[
                            { icon: '💤', label: 'Sleep Tip',      tip: '7–9 hrs = cell regeneration', color: '#eef2ff', border: '#c7d2fe' },
                            { icon: '🧘', label: 'Stress Tip',     tip: 'Calm mind = clear skin',      color: '#fff1f2', border: '#fecdd3' },
                            { icon: '💧', label: 'Hydration Tip',  tip: '8 glasses keeps skin plump',  color: '#f0f9ff', border: '#bae6fd' },
                            { icon: '🥗', label: 'Diet Tip',       tip: 'Antioxidants fight aging',    color: '#f0fdf4', border: '#bbf7d0' },
                        ].map((tip, i) => (
                            <div
                                key={i}
                            ...
                            >
                                <span className="mt-0.5 text-sm leading-none">{tip.icon}</span>
                                <div>
                                    <p className="text-[10px] font-bold text-slate-700">{tip.label}</p>
                                    <p className="text-[10px] leading-snug text-slate-400">{tip.tip}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mt-3 flex items-center gap-2.5 rounded-2xl border border-slate-200/80 bg-white/60 px-4 py-3 backdrop-blur-sm">
                    ...
                    <p className="text-[11px] text-slate-400">
                        ...
                        <span className="font-semibold text-slate-600">private</span>
                        {' '}and used only to personalize your skincare journey.
                    </p>
                </div>
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f4f9ec] via-[#eef5e0] to-[#e6f0d4] px-4 py-8 sm:py-12">
        <div className="mx-auto w-full max-w-3xl">
            ...
            <div className="mb-8 space-y-3 text-center sm:mb-10">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-500 sm:text-base">
                    Our AI examines tone, texture, and unique characteristics to provide recommendations tailored to you.
                </p>
            </div>
                ...
                <div className="relative grid gap-0 lg:grid-cols-2">
                    ...
                    <div className="space-y-5 border-b border-slate-100 p-5 sm:p-7 lg:border-b-0 lg:border-r">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Pro Tips</span>
                        </div>

                        {/* Tips List */}
                        <ul className="space-y-3">
                            {[
                                { icon: '☀️', label: 'Lighting',    text: 'Use natural daylight near a window — avoid harsh overhead lights', bg: '#fffbeb', border: '#fde68a' },
                                { icon: '🧼', label: 'Clean Face',  text: 'Remove makeup and cleanse for accurate texture analysis',          bg: '#f0fdf4', border: '#bbf7d0' },
                                { icon: '📸', label: 'Stay Steady', text: 'Keep face centered and camera steady to avoid blur',               bg: '#eff6ff', border: '#bfdbfe' },
                                { icon: '😐', label: 'Expression',  text: 'Neutral expression works best — no squinting or smiling',          bg: '#fdf4ff', border: '#e9d5ff' },
                            ].map((tip, i) => (
                                <li key={i} className="flex items-start gap-3">
                                    ...
                                    <div className="pt-0.5">
                                        <p className="text-xs font-bold text-slate-700">{tip.label}</p>
                                        <p className="text-xs leading-relaxed text-slate-400">{tip.text}</p>
                                    </div>
                                </li>
                            ))}
                        </ul>
                        ...
                        <div className="relative flex items-center gap-3">
                            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-slate-200 to-transparent" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-slate-300">AI</span>
                            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-slate-200 to-transparent" />
                        </div>
                        ...
                        <div className="flex items-start gap-3 rounded-2xl border border-sky-100 bg-gradient-to-br from-sky-50 to-blue-50/60 px-4 py-3.5">
                            ...
                            <div>
                                <p className="text-xs font-bold text-slate-700">AI-Powered Analysis</p>
                                <p className="mt-0.5 text-xs leading-relaxed text-slate-400">
                                    Analyzes skin tone, texture, pores, and concerns with clinical-grade accuracy.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 p-5 sm:p-7">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Your Photo</span>
                        </div>
                            ...
                            {cameraActive ? (
                                ...
                                <div className="space-y-3 p-3">
                                    ...
                                    <div className="flex items-center gap-2.5 rounded-xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-green-50 px-3 py-2.5">
                                        ...
                                        <span className="text-xs font-bold text-emerald-800">Photo ready for analysis</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex h-64 flex-col items-center justify-center gap-3 p-6 text-center">
                                    <div
                                        ...
                                        style={{ background: 'linear-gradient(135deg, #f0f5e3, #e4f0cc)', border: '1.5px solid #c5d98a' }}
                                    >
                                        <svg className="h-8 w-8 text-[#7aaa2e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold text-slate-700">No photo yet</p>
                                    ...
                                    <div className="mt-1 flex items-center gap-1.5 rounded-lg border border-dashed border-[#97b94f]/40 bg-[#f9fcf3] px-3 py-1.5">
                                        ...
                                        <span className="text-[10px] font-semibold text-[#6a8a2e]">Tap Upload or Use Webcam above</span>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex items-start gap-2.5 rounded-2xl border border-[#e8f0d5] bg-[#f9fcf3] px-4 py-3">
                            ...
                            <p className="text-[11px] leading-relaxed text-slate-400">
                                <span className="font-semibold text-slate-600">Photo encrypted & secure.</span>{' '}
    ...
    return (
      <div className="w-full space-y-8 sm:space-y-12 px-2 sm:px-4 py-4 sm:py-8">
        ...
        <div className="space-y-3 sm:space-y-4 text-center -mx-15">
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base text-slate-600">
            Your daily habits play a crucial role in skin health. Help us
            understand your routine so we can recommend holistic solutions.
          </p>
        </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 -mx-15">
                {LIFESTYLE_OPTIONS[field.key].map((option) => (
                  <button
                    ...
                    key={option.value}
                    onClick={() => handleAnswerChange(field.key, option.value)}
                    className={`group relative overflow-hidden rounded-xl border-2 px-4 sm:px-5 py-3 sm:py-4 text-left shadow-sm transition-all duration-200 ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-700">
                  Great skin isn't just about products—it's about balance. We'll
                  combine your lifestyle insights with targeted treatments for
                  optimal results.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-600">
                  7-9 hours promotes cell regeneration
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-600">
                  8 glasses daily keeps skin plump
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
        <Card className="border border-slate-200 bg-white p-4 sm:p-6 shadow-sm">
          ...
          <ul className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <li>
              <span className="font-medium">Gender:</span> {lead.gender || "—"}
            </li>
          </ul>
        </Card>
